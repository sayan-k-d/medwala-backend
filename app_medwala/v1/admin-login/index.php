...
if(isset($_COOKIE['user']) && !isset($_SESSION['loggedin'])) {
    //exit;
    $find_usercookie = find("first", ACCOUNTS, '*', "WHERE username = '".$_COOKIE['user']."' ", array());
    if($find_usercookie){
                                ...
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="form-horizontal auth-form" action="authenticate.php" method="post">
                                        <div class="form-group">
                                            <input required="" name="username" type="email" class="form-control" placeholder="Username" id="exampleInputEmail1">
                                        </div>
                                        <div class="form-group">
