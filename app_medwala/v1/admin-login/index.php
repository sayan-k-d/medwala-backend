<?php
    ...
    if (isset($_COOKIE['user']) && ! isset($_SESSION['loggedin'])) {
        //exit;
        $find_usercookie = find("first", ACCOUNTS, '*', "WHERE username = '" . $_COOKIE['user'] . "' ", []);
        if ($find_usercookie) {
            $_SESSION['loggedin']  = true;
            $_SESSION['adminname'] = $find_usercookie['username'];
            $_SESSION['adminid']   = $find_usercookie['id'];
    ...
    <div class="page-wrapper">
		...
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z" />
                            ...
                            <div class="single-item">
                                <div>
                                    <div>
                                        <h3>Welcome to MedWala</h3>
                                        <p>Put Your Username And Password To Login</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="top-profile-tab" data-toggle="tab"
                                            ...
                                            aria-selected="true"><i class="fa fa-user"></i> Login</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="top-contact-tab" data-toggle="tab" href="#top-contact"
                                            role="tab" aria-controls="top-contact" aria-selected="true"><i
                                ...
                                <div class="tab-content" id="top-tabContent">
                                    <div class="tab-pane fade show active" id="top-profile" role="tabpanel"
                                        ...
                                        <form class="form-horizontal auth-form" action="authenticate.php" method="post">
                                    ...
                                    <div class="tab-pane fade show" id="top-contact" role="tabpanel"
                                        aria-labelledby="contact-top-tab">
                                        <form class="form-horizontal auth-form" action="register.php" method="post">
                                            <div class="form-group">
                                                <input required="" name="username" type="email" class="form-control"
                                            ...
                                            <div class="form-group">
                                                <input required="" name="conf_password" type="password"
                                                    class="form-control" placeholder="Confirm Password">
                                            </div>
                                            <div class="form-terms">
                                                <div class="custom-control custom-checkbox mr-sm-2">
                                                    <input type="checkbox" name="terms" class="custom-control-input"
                                                        id="customControlAutosizing1" required>
                                                    <label class="custom-control-label"
