...
session_start();
	...
	if(isset($_POST['submit']))
	{
		...
		,lon=:lon,refcontact=:refcontact,refname=:refname,lecontact=:lecontact,lastemployer=:lastemployer,skillsets=:skillsets,mdt=:mdt,pannumber=:pannumber,adharnumber=:adharnumber,status=:status,visible=:visible";
	...
	if(isset($_GET['pdid']))
	{
		...
		header("location:edit-vendor-pending.php?id=".$id);
	}
							...
							<div class="col-lg-12 mb-5">
								<div class="card">
								  <div class="card-header">
									<h3 class="h6 text-uppercase mb-0">FILL DETAILS TO APPROVE VENDOR</h3>
								  </div>
								   <div class="card-body">
