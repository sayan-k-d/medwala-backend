<?php
    ...
    if(isset($_GET['getprescriptionsonly'])){
        ...
        if($obj['reqId'] == 'asiduxm3uyri2nyri2yn3r23r9234394024823948'){
        	...
        	if($obj['userid'] != ''){
        	    ...
        	    if($find_subuser){
        	       ...
        	       $find_shop = find("first", SHOP, '*', "WHERE id = '".$find_subuser['shopid']."'", array());
        	        ...
        	        $find_quotes = find("all", QUOTATIONREQUEST, '*', "WHERE shopid = '".$find_subuser['shopid']."' AND status = 'submitted' ORDER BY id DESC", array());
